...
PKG_DEPENDS_TARGET="toolchain SDL2 nasm:host ${OPENGLES} libevdev libmali"
...
pre_configure_target() {
	mkdir -p "${SYSROOT_PREFIX}/usr/include/libevdev-1.0/linux"
	cp "${SYSROOT_PREFIX}/usr/include/lirc/include/linux/input-event-codes.h" "${SYSROOT_PREFIX}/usr/include/libevdev-1.0/linux"
